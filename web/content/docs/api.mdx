---
title: Toast API
description: Imperative API for creating and managing toasts. Methods, options, deduplication, and TypeScript types.
---
...
Custom toasts render with `data-type="custom"` on the root. See [Custom Toasts](/docs/custom) for details.

### `toast.promise(promiseOrFn, options)`

See [Promise Toasts](/docs/promise) for the full guide.
...
See [Anchored Toasts](/docs/anchored) for the full guide.
